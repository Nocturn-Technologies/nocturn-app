...
INSERT INTO ticket_tiers (id, event_id, name, price, capacity, tickets_sold, is_active, sort_order) VALUES
  ('a1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'Early Bird', 20.00,  50, 0, true, 0),
  ('a1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000001', 'GA',         30.00, 150, 0, true, 1),
  ('a1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000001', 'Door',       40.00,  50, 0, true, 2)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO ticket_tiers (id, event_id, name, price, capacity, tickets_sold, is_active, sort_order) VALUES
  ('a1000000-0000-0000-0000-000000000011', 'e1000000-0000-0000-0000-000000000002', 'Early Bird', 25.00,  40, 0, true, 0),
  ('a1000000-0000-0000-0000-000000000012', 'e1000000-0000-0000-0000-000000000002', 'GA',         35.00, 140, 0, true, 1)
ON CONFLICT (id) DO NOTHING;
