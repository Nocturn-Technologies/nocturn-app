  ...
  if (loading) {
    return (
      <div className="space-y-6 animate-in fade-in duration-300">
        ...
        {/* Attendee rows skeleton */}
        <div className="space-y-2">
          <div className="h-4 w-24 rounded bg-muted animate-pulse px-4" />
          {[1, 2, 3, 4, 5].map((i) => (
            <Card key={i} className="rounded-2xl">
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4 animate-in fade-in duration-300">
        ...
        <div className="text-center space-y-1">
          <p className="font-semibold text-lg">Failed to load attendees</p>
        ...
        <Button
          variant="outline"
          className="rounded-xl min-h-[44px] transition-colors duration-200 hover:border-nocturn/30 active:scale-[0.97]"
    ...
    <div className="space-y-6 overflow-x-hidden animate-in fade-in duration-300">
      <div className="flex items-center justify-between gap-4">
        ...
        {attendees.length > 0 && (
          <Button
            variant="outline"
            className="min-h-[44px] rounded-xl shrink-0 transition-colors duration-200 hover:border-nocturn/30 active:scale-[0.97]"
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Card className="rounded-2xl transition-colors duration-200 hover:border-nocturn/20">
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div className="min-w-0">
              <p className="text-xs text-muted-foreground truncate">Total Attendees</p>
      ...
      {filtered.length > 0 ? (
        <div className="space-y-2">
          ...
          {paginatedAttendees.map((attendee) => (
            <Card key={attendee.email} className="rounded-2xl transition-colors duration-200 hover:border-nocturn/20">
              <CardContent className="p-4">
                {/* Desktop row */}
                <div className="hidden sm:grid grid-cols-12 items-center gap-2">
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 pt-4">
              <Button
                ...
                className="min-h-[44px] min-w-[44px] rounded-xl transition-colors duration-200 hover:border-nocturn/30 active:scale-[0.95]"
              >
              ...
              {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                ...
                return (
                  <Button
                    ...
                    className={`min-h-[44px] min-w-[44px] rounded-xl transition-colors duration-200 active:scale-[0.95] ${page === pageNum ? "bg-nocturn hover:bg-nocturn-light" : "hover:border-nocturn/30"}`}
                  >
                    {pageNum}
                  </Button>
                );
        ...
        <Card className="rounded-2xl">
          <CardContent className="flex flex-col items-center gap-4 py-12">
            ...
            <Link href="/dashboard/events">
              <Button className="bg-nocturn hover:bg-nocturn-light rounded-xl mt-2 min-h-[44px] transition-colors duration-200 active:scale-[0.97]">
                View Your Events
              </Button>
            </Link>
          </CardContent>
