      ...
      <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-5 space-y-4">
        ...
        {igHandle && (
          <a
            ...
            className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-white/10 min-h-[44px]"
          >
